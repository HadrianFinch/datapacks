...
tellraw @a {"text": "To complete: Enter the nether, collect blaze rods from a fortress, combine them with Ender Pearls to locate the fortress, enter the end, and defeat the dragon.", "bold": false}
tellraw @a {"text": "", "bold": false}
