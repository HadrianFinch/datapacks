...
give @p elytra{Enchantments: [{id: "mending", lvl:1}, {id:"minecraft:vanishing_curse",lvl:1s}]}

give @p netherite_boots{display:{Name:'{"text":"Dasher\'s Boots","color":"aqua","bold":true}'},HideFlags:7,Unbreakable:1b,dasher_boots:1b,Enchantments:[{id:"minecraft:feather_falling",lvl:20s},{id:"minecraft:vanishing_curse",lvl:1s},{id:"minecraft:depth_strider",lvl:14s},{id:"minecraft:frost_walker",lvl:3s},{id:"minecraft:soul_speed",lvl:8s},{id:"minecraft:swift_sneak",lvl:8s}],Trim:{material:"minecraft:diamond",pattern:"minecraft:wayfinder"}} 1

give @p nether_star{HideFlags:1,display:{Name:'{"text":"+ Regeneration Aura +","color":"green"}',Lore:['{"text":"Hold in offhand to activate","color":"dark_green","italic":true}']},regen_aura:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}]} 1
give @p nether_star{HideFlags:1,display:{Name:'{"text":"- Wither Aura -","color":"red"}',Lore:['{"text":"Hold in offhand to activate","color":"dark_red","italic":true}']},wither_aura:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}]} 1
...
give @p trident{display:{Name:'{"text":"Oceanmaster\'s Wake","color":"blue","bold":true,"italic":false}'},HideFlags:5,Unbreakable:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s},{id:"minecraft:impaling",lvl:20s},{id:"minecraft:riptide",lvl:10s}]} 1
give @p trident{display:{Name:'{"text":"Oceanmaster\'s Might","color":"aqua","bold":true,"italic":false}'},HideFlags:5,Unbreakable:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s},{id:"minecraft:loyalty",lvl:90s},{id:"minecraft:impaling",lvl:20s},{id:"minecraft:channeling",lvl:1s}]} 1
give @p golden_helmet{display:{Name:'{"text":"Oceanmaster\'s Crown","color":"dark_aqua","bold":true,"italic":false}'},HideFlags:5,Unbreakable:1b,oceanmaster_crown:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s},{id:"minecraft:fire_protection",lvl:100s},{id:"minecraft:respiration",lvl:100s},{id:"minecraft:aqua_affinity",lvl:100s}]} 1

give @p leather_chestplate{display:{Name:'{"text":"Cloak of Invisbility","color":"dark_gray","bold":true,"italic":false}',color:0},HideFlags:69,Unbreakable:1b,invisibility_cloak:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s},{id:"minecraft:vanishing_curse",lvl:1s}]} 1

give @p crossbow{display:{Name:'{"text":"Hunter\'s Crossbow","color":"dark_red","bold":false,"italic":false}'},HideFlags:5,Unbreakable:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s},{id:"minecraft:multishot",lvl:3s},{id:"minecraft:piercing",lvl:120s},{id:"minecraft:quick_charge",lvl:3s}],ChargedProjectiles:[{id:"minecraft:spectral_arrow",Count:1b},{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:100b,Explosions:[{Type:2,Flicker:1b,Colors:[I;16711680],FadeColors:[I;16711680]}]}}},{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:120b,Explosions:[{Type:2,Flicker:1b,Colors:[I;16711680],FadeColors:[I;16711680]}]}}}],Charged:1b} 1
give @p elder_guardian_spawn_egg{EntityTag:{id:"minecraft:wolf",CustomName:'"Name Me!"',CustomNameVisible:1,PersistenceRequired:1b,CanPickUpLoot:0b,Health:200,Attributes:[{Name:"minecraft:generic.max_health",Base:200},{Name:"minecraft:generic.attack_damage",Base:5}],Invulnerable:1,Age:0,CollarColor:6,ActiveEffects:[{Id:10,Amplifier:3,Duration:-1,ShowParticles:0b},{Id:11,Amplifier:9,Duration:-1,ShowParticles:0b}],Tags:["hunter_wolf:1b"]}} 10
give @p name_tag 12
give @p anvil