...
tellraw @s [{"text":"Min required levels: ","color":"aqua","hoverEvent":{"action":"show_text","contents":[{"text":"Sets the number of minimum levels required to set CustomModelData.\nSet to 0 to disable level requirement.","color":"yellow"}]},"clickEvent":{"action":"suggest_command","value":"/scoreboard players set #min_level crd_xp_dummy"}},{"score":{"name":"#min_level","objective":"crd_xp_dummy"},"color":"green"}]