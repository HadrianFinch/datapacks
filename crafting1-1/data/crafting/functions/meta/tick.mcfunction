...
execute as @e[type=armor_stand,tag=crafting.armor.table,tag=crafting.hight.set,scores={crafting.pos=0}] at @s align xyz run summon block_display ~ ~1 ~ {NoGravity:1b,Silent:1b,block_state:{Name:"minecraft:brewing_stand",Properties:{has_bottle_0:"true",has_bottle_1:"true",has_bottle_2:"true"}}, Tags:["crafting.itemstanddisplay"]}
...
execute as @e[type=armor_stand,tag=crafting.armor.table,tag=crafting.hight.set,scores={crafting.pos=1..}] at @s align xyz run summon block_display ~ ~2 ~ {NoGravity:1b,Silent:1b,block_state:{Name:"minecraft:brewing_stand",Properties:{has_bottle_0:"true",has_bottle_1:"true",has_bottle_2:"true"}}, Tags:["crafting.itemstanddisplay"]}
...
execute as @e[type=armor_stand,tag=crafting.stand.table] at @s unless block ~ ~1 ~ dropper run kill @e[tag=crafting.itemstanddisplay,limit=1,sort=nearest]
